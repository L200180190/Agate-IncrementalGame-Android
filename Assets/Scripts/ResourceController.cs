...
public class ResourceController : MonoBehaviour
{
    ...
    private int _level
    {
        set
        {
            // Simpan value yg di set ke _level pada Progress Data
        ...
        get
        {
            ...
            // Jika ya, tampilkan berdasar Progress Data
    ...
    public void SetUnlocked (bool unlocked)
    {
        ...
        if (unlocked)
        {
            // Jika resources baru unlocked dan belum ada di Progress Data, maka tambah data
            if (!UserDataManager.HasResources(_index))
            {
